...
const NAMESPACE = 'zero-ui-web';
const BUILD = /* zero-ui-web */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: true, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: true, propMutable: true, propNumber: true, propString: true, reflect: true, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: true, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: false, vdomListener: true, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false, watchCallback: false };
...
class Color {
  constructor(input) {
    ...
    if (input.hex) {
      ...
      this.red = Color.clamp((_a = input.red) !== null && _a !== void 0 ? _a : 0);
      this.green = Color.clamp((_b = input.green) !== null && _b !== void 0 ? _b : 0);
      this.blue = Color.clamp((_c = input.blue) !== null && _c !== void 0 ? _c : 0);
    }
  }
  get brightness() {
...
class ZeroContainer {
  constructor(hostRef) {
    ...
    // Background
    this.background = 'var(--color-background, transparent)';
    this.backgroundBlur = 0;
    this.backgroundTranslucency = 1;
    // Shadows
    this.shadowProminence = 0.5;
    this.elevation = 0;
    this.neuness = 0;
    // Glow
    this.glowAmount = 0;
  ...
  get glows() {
    if (this.glowAmount <= 0)
      return false;
    if (this.backgroundTranslucency > 0)
      return false;
    return true;
  }
  get hasEdge() {
    if (this.edgeThickness <= 0)
      return false;
    if (this.backgroundTranslucency > 0)
      return false;
    return true;
  ...
  get cssVars() {
    ...
    if (this.lightScheme || this.darkScheme) {
      const scheme = colorSchemeFor((_b = (this.dark ? (_a = this.darkScheme) !== null && _a !== void 0 ? _a : this.lightScheme : this.lightScheme)) !== null && _b !== void 0 ? _b : 'light');
      if (scheme)
        Object.assign(vars, scheme.cssVars);
    }
  ...
  render() {
    return (hAsync("div", { class: this.classes, style: this.cssVars }, this.hasEdge ? hAsync("div", { class: "edge-background" }) : null, this.hasEdge ? hAsync("div", { class: "edge" }) : null, hAsync("div", { class: "container" }, hAsync("div", { class: "background" }), this.glows ? hAsync("div", { class: "glow" }) : null, hAsync("div", { class: "content" }, hAsync("slot", null)))));
  }
  componentWillLoad() {
  ...
  static get cmpMeta() { return {
    ...
    "$members$": {
      ...
      "darkScheme": [1, "dark-scheme"],
      "background": [1],
      "backgroundBlur": [2, "background-blur"],
      "backgroundTranslucency": [2, "background-translucency"],
      "backgroundGradient": [1, "background-gradient"],
      "shadowProminence": [2, "shadow-prominence"],
      "elevation": [2],
      "neuness": [2],
      "glowAmount": [2, "glow-amount"],
...
const dividerCss = "/*!@.divider*/.divider.sc-zero-divider{display:block;width:100%;background:var(--gradient, var(--color-text, #fff));height:var(--thickness, 2px);margin:var(--spacing, 1rem) 0;border-radius:10rem}";
...
class ZeroDivider {
  ...
  render() {
    var _a, _b, _c;
    return (hAsync("div", { class: "divider", style: {
        '--thickness': `${this.thickness}px`,
        '--spacing': `${this.spacing}rem`,
        '--gradient': (_c = (_b = gradientFor((_a = this.gradient) !== null && _a !== void 0 ? _a : '')) === null || _b === void 0 ? void 0 : _b.cssBackground) !== null && _c !== void 0 ? _c : 'var(--color-text-primary, #000)',
      } }));
  }
  static get style() { return dividerCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "zero-divider",
    "$members$": {
      "thickness": [2],
      "spacing": [2],
      "gradient": [1]
...
class ZeroGrid {
  ...
  render() {
    return (hAsync("div", { class: "zero-grid", style: {
        '--spacing': `${this.spacing}rem`,
        '--min-width': this.minWidth,
      } }, hAsync("slot", null)));
  }
...
class ZeroHeader {
  ...
  static get style() { return zeroHeaderCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "zero-header",
    "$members$": {
...
class ZeroInput {
  ...
  render() {
    var _a, _b, _c;
    return (hAsync("zero-container", { elevation: this.elevation, padding: this.padding, paddingRatio: this.paddingRatio, shadowProminence: 0.3, roundedCorners: 0.5, edgeBrightness: 0.05, edgeThickness: 0.1, glowAmount: 0.05, edgeGlow: 0.2, spacing: 0.4, background: "var(--color-inputs, transparent)", "background-translucency": 0, direction: "horizontal", class: {
        'show-error': ((_a = this.error) === null || _a === void 0 ? void 0 : _a.length) > 0,
      } }, hAsync("zero-container", { spacing: 0.3 }, hAsync("zero-container", { spacing: this.spacing, direction: this.correctDirection }, hAsync("zero-container", { direction: "horizontal", fill: true, flexFill: false }, hAsync("zero-text", { size: 0.9, weight: 600, icon: this.icon, family: "Inter" }, this.label), this.type === 'range' ? (hAsync("p", { class: "value" }, this.valueTemplate.replace('{{value}}', (_c = (_b = this.value) === null || _b === void 0 ? void 0 : _b.toString().trim()) !== null && _c !== void 0 ? _c : ''))) : null), hAsync("input", { name: this.name, type: this.type, placeholder: this.placeholder, min: this.min, max: this.max, step: this.step, value: this.value, onInput: (e) => {
        this.hasTyped = true;
        this.value = e.target.value;
        this.valueChanged.emit(this.value);
        this.error = this.errorValue();
      } })), hAsync("div", { class: "error" }, hAsync("zero-text", { lightScheme: "red", darkScheme: "red", color: "var(--color-primary, #000)", size: 0.9 }, this.errorLabel)))));
  }
  ...
  static get cmpMeta() { return {
    ...
    "$members$": {
      ...
      "max": [2],
      "step": [2],
      "valueTemplate": [1, "value-template"],
      "direction": [1],
      "value": [1544],
      "icon": [1],
      "elevation": [2],
      ...
      "validate": [4],
      "required": [4],
      "showErrorBeforeType": [4, "show-error-before-type"],
      "validator": [16],
      "hasTyped": [32],
      "error": [32],
      "errorLabel": [32]
...
class ZeroScaffold {
  ...
  render() {
    return (hAsync("div", { id: "scaffold", style: {
        '--font': this.font,
      }, class: {
        'not-scrolled': !this.scrolled,
      } }, hAsync("zero-container", { lightScheme: this.lightScheme, darkScheme: this.darkScheme, flex: false, background: "var(--color-scaffold, transparent)", backgroundTranslucency: 0 }, hAsync("div", null, hAsync("slot", { name: "header" })), hAsync("div", { class: "scaffold-content" }, hAsync("slot", { name: "content" })), hAsync("div", null, hAsync("slot", { name: "footer" })))));
  }
  get el() { return getElement(this); }
  static get style() { return scaffoldCss; }
  static get cmpMeta() { return {
    "$flags$": 4,
    "$tagName$": "zero-scaffold",
    "$members$": {
      "lightScheme": [1, "light-scheme"],
      "darkScheme": [1, "dark-scheme"],
      "font": [1],
...
const zeroSectionCss = "/*!@section*/section.sc-zero-section{display:flex;flex-direction:column;align-items:center;width:100%}/*!@.section-header*/.section-header.sc-zero-section{display:inline-flex;flex-direction:column;padding-bottom:2rem}/*!@.section-content*/.section-content.sc-zero-section{width:100%}";

class ZeroSectionHeader {
  constructor(hostRef) {
    registerInstance(this, hostRef);
  }
  render() {
    return (hAsync("section", { class: "section" }, hAsync("div", { class: "section-header" }, hAsync("zero-text", { "text-style": "display-4", gradient: this.gradient, icon: this.icon }, this.sectionTitle), hAsync("zero-divider", { thickness: 6, gradient: this.gradient })), hAsync("div", { class: "section-content" }, hAsync("slot", null))));
  }
  static get style() { return zeroSectionCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "zero-section",
    "$members$": {
...
function styleForName(styleName) {
  var _a;
  return ((_a = styles.find((style) => normalizeStyleName(style.name) === normalizeStyleName(styleName))) !== null && _a !== void 0 ? _a : new TextStyle());
}
...
const textCss = "/*!@p*/p.sc-zero-text{display:block;color:var(--text-color, #000);font-family:var(--font-family, var(--font, sans-serif));font-size:var(--font-size, 1rem);font-weight:var(--font-weight, 400);-webkit-font-smoothing:antialiased;text-rendering:optimizelegibility;-webkit-text-size-adjust:100%;-moz-text-size-adjust:100%;text-size-adjust:100%;padding:0;margin:0;letter-spacing:var(--letter-spacing, -0.02rem);line-height:var(--line-height, 1);text-align:var(--text-align, left)}/*!@.uppercase span.content*/.uppercase.sc-zero-text span.content.sc-zero-text{text-transform:uppercase}/*!@.underline span.content*/.underline.sc-zero-text span.content.sc-zero-text{text-decoration:underline}/*!@.lowercase span.content*/.lowercase.sc-zero-text span.content.sc-zero-text{text-transform:lowercase}/*!@.gradient p*/.gradient.sc-zero-text p.sc-zero-text{-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;-moz-text-fill-color:transparent;line-height:1.2;background-image:var(--background-gradient, none)}/*!@.style-normal*/.style-normal.sc-zero-text{font-weight:400;font-size:1.2rem}/*!@.material-symbols-outlined*/.material-symbols-outlined.sc-zero-text{font-family:'Material Symbols Outlined';font-weight:var(--font-weight, 400);font-style:normal;font-size:calc(var(--font-size, 1.1rem) * 1.15);letter-spacing:normal;text-transform:none;display:inline-block;white-space:nowrap;word-wrap:normal;vertical-align:text-bottom;direction:ltr;font-feature-settings:'liga';-webkit-font-smoothing:antialiased;font-variation-settings:'FILL' 0, 'wght' 500, 'GRAD' 0, 'opsz' 42;color:var(--text-color, #000)}/*!@.has-text .material-symbols-outlined*/.has-text.sc-zero-text .material-symbols-outlined.sc-zero-text{padding-left:var(--icon-left-spacing, 0);padding-right:var(--icon-right-spacing, 0)}";
...
class ZeroText {
  ...
  get cssVars() {
    var _a, _b, _c, _d;
    let vars = (_c = (_b = styleForName((_a = this.textStyle) !== null && _a !== void 0 ? _a : 'normal')) === null || _b === void 0 ? void 0 : _b.cssVars) !== null && _c !== void 0 ? _c : {};
    if (this.family)
      vars['--font-family'] = this.family;
    if (this.size)
      vars['--font-size'] = `${this.size}rem`;
    if (this.weight)
      vars['--font-weight'] = this.weight.toString();
    if (this.lineHeight)
      vars['--line-height'] = this.lineHeight.toString();
    if (this.letterSpacing)
      vars['--letter-spacing'] = `${this.letterSpacing}rem`;
    if (((_d = this.color) === null || _d === void 0 ? void 0 : _d.length) > 0)
      vars['--text-color'] = this.color;
