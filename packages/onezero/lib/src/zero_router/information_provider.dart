...
/// [ZeroRouteInformationPrarser].
///
/// This state class is used internally in zero_router and will not be send to
/// the engine.
class RouteInformationState<T> {
  ...
  /// The extra object used when navigating with [ZeroRouter].
  final Object? extra;
...
/// The [RouteInformationProvider] created by zero_router.
class ZeroRouteInformationProvider extends RouteInformationProvider
    with WidgetsBindingObserver, ChangeNotifier {
  /// Creates a [ZeroRouteInformationProvider].
  ZeroRouteInformationProvider({
  ...
  void routerReportsNewRouteInformation(RouteInformation routeInformation,
    ...
    // ZeroRouteInformationParser should always report encoded route match list
    // in the state.
