...
/// The function signature of [ZeroRouteInformationParser.onParserException].
///
...
class ZeroRouteInformationParser
    extends RouteInformationParser<RouteMatchList> {
  /// Creates a [ZeroRouteInformationParser].
  ZeroRouteInformationParser({
  ...
  RouteInformation? restoreRouteInformation(RouteMatchList configuration) {
    ...
    if (ZeroRouter.optionURLReflectsImperativeAPIs &&
