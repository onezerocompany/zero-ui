...
/// context.go('/');
extension ZeroRouterHelper on BuildContext {
  ...
  String namedLocation(
    ...
    Map<String, dynamic> queryParameters = const <String, dynamic>{},
      ...
      ZeroRouter.of(this).namedLocation(name,
          pathParameters: pathParameters, queryParameters: queryParameters);

  /// Navigate to a location.
  void go(String location, {Object? extra}) =>
      ZeroRouter.of(this).go(location, extra: extra);
  ...
  Future<T?> push<T extends Object?>(String location, {Object? extra}) =>
      ZeroRouter.of(this).push<T>(location, extra: extra);
  ...
  Future<T?> pushNamed<T extends Object?>(
    ...
    Object? extra,
      ...
      ZeroRouter.of(this).pushNamed<T>(
        name,
        pathParameters: pathParameters,
        queryParameters: queryParameters,
        extra: extra,
  ...
  bool canPop() => ZeroRouter.of(this).canPop();

  /// Pop the top page off the Navigator's page stack by calling
  /// [Navigator.pop].
  void pop<T extends Object?>([T? result]) => ZeroRouter.of(this).pop(result);
  ...
  void pushReplacement(String location, {Object? extra}) =>
      ZeroRouter.of(this).pushReplacement(location, extra: extra);
  ...
  void pushReplacementNamed(
    ...
    Object? extra,
      ...
      ZeroRouter.of(this).pushReplacementNamed(
        name,
        pathParameters: pathParameters,
        queryParameters: queryParameters,
        extra: extra,
  ...
  void replace(String location, {Object? extra}) =>
      ZeroRouter.of(this).replace(location, extra: extra);
  ...
  void replaceNamed(
    ...
    Object? extra,
      ...
      ZeroRouter.of(this).replaceNamed(name,
          pathParameters: pathParameters,
          queryParameters: queryParameters,
          extra: extra);
}
