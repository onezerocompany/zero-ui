...
class ImperativeRouteMatch extends RouteMatch {
  ...
  static ZeroPage _getsLastRouteFromMatches(RouteMatchList matchList) {
...
class RouteMatchList {
  ...
  List<ZeroPage> get routes => matches.map((RouteMatch e) => e.route).toList();
