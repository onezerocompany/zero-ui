...
exports.withThemeFromJSXProvider = void 0;
...
var withThemeFromJSXProvider = function withThemeFromJSXProvider(_ref3) {
  ...
  (0, _helpers.initializeThemeState)(themeNames, defaultTheme || themeNames[0]);
  return function (storyFn, context) {
    ...
    var ProviderComponent = Provider || _react["default"].Fragment;
    return /*#__PURE__*/_react["default"].createElement(ProviderComponent, {
      theme: theme
    }, GlobalStyles && /*#__PURE__*/_react["default"].createElement(GlobalStyles, null), storyFn());
  };
};
